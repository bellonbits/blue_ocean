...
const translations = {
  en: {
    ...
    footer: {
      ...
      copyright: (year) => `© ${year} Blue Heaven Somalia. All rights reserved.`,
    ...
    common: {
      ...
      getInvolvedCta: {
        ...
        partnerTagline: 'Work with Blue Heaven to create lasting impact.',
    ...
    home: {
      ...
      heroHeadlineAccent: 'Blue Heaven',
  ...
  so: {
    ...
    footer: {
      ...
      copyright: (year) => `© ${year} Blue Heaven Somalia. Dhammaan xuquuqda way dhowran yihiin.`,
      mission: 'Ilaalinta badda Soomaaliya ee jiilasha soo socda.',
    },
    auth: {
      logIn: 'Gal',
    ...
    common: {
      ...
      exploreCta: {
        eyebrow: 'Aragtiyada Cusub',
        heading: 'Xeebtu waxay sugaysaa',
      ...
      getInvolvedCta: {
        ...
        volunteerCta: 'Noqo Mutadawac',
        partnerTitle: 'Nala Shaqee',
        partnerTagline: 'La shaqee Blue Heaven si aad u abuurto saameyn waara.',
    ...
    home: {
      ...
      heroHeadlineAccent: 'Blue Heaven Soomaaliya',
