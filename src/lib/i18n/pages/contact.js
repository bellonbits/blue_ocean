  ...
  en: {
    contact: {
      ...
      details: {
        ...
        followLabel: 'Follow Blue Heaven',
      },
      form: {
        nameLabel: 'Name',
        ...
        successMessage: "Thank you for contacting Blue Heaven. We'll get back to you as soon as possible.",
  ...
  so: {
    contact: {
      ...
      details: {
        ...
        followLabel: 'La Soco Blue Heaven',
      },
      form: {
        nameLabel: 'Magaca',
        ...
        successMessage: 'Waad ku mahadsan tahay inaad la xiriirtay Blue Heaven. Waan kula soo xiriiri doonnaa sida ugu dhaqsaha badan ee suurtagalka ah.',
