// about page-section UI strings — merged into the shared dictionary in
...
export default {
  ...
  so: {
    about: {
      ...
      missionVision: {
        label: 'WAXA NA DHIIRIGELIYA',
        heading: 'Ujeedka iyo Aragtida',
        missionLabel: 'Ujeedka',
        visionLabel: 'Aragtida',
      },
      whatWeDo: {
        label: 'HABKAYAGA',
        heading: 'Waxa Aan Qabanno',
      },
      whereWeWork: {
