...
export default function ConservationCoastConnection({ project }) {
  if (!project.destinations || project.destinations.length === 0) return null;

  return (
    <section className="exp-locations-sec section" aria-labelledby="conservation-loc-heading">
      <div className="container">
        <div className="section-header reveal">
          <span className="label-text">ON THE GROUND</span>
          <div className="divider" />
          <h2 className="section-heading" id="conservation-loc-heading">
        ...
        <div className="exp-locations-layout">
          <div className="exp-locations-intro reveal">
            <div className="exp-locations-card">
              ...
              <h3 className="exp-locations-card-title">Region</h3>
              <p className="exp-locations-card-desc">{project.region}, Somalia</p>
            </div>
          </div>
          ...
          <div className="exp-locations-dest reveal">
            <div className="exp-locations-dest-header">
              <div className="exp-locations-dest-title-wrap">
                ...
                <h3 className="exp-locations-dest-title">Connected Destinations</h3>
              </div>
