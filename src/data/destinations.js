...
Blue Heaven works with local elders and fishing cooperatives in Bargaal to document traditional marine territorial rights and protect juvenile fish nurseries in coastal shallows.`,
...
Blue Heaven is beginning baseline surveys of Berbera’s nearshore reef flats and lagoon systems, an area of the Gulf of Aden that remains comparatively under-documented despite its long human history.`,
...
Blue Heaven views Zeila as a priority site for documenting how a historic Gulf of Aden port town's marine life and fishing practices have shifted over time, alongside the town's largely unrestored maritime heritage.`,
...
The beaches of Kismayo—stretching unbroken for tens of kilometers with powdery white sand—represent some of the finest natural coastlines in Eastern Africa. Blue Heaven conducts regular community beach cleanups, youth ocean education classes, and mangrove reforestation projects here.`,
...
Blue Heaven is actively working with regional rangers and community representatives to designate key stretches of Ras Kamboni as protected marine sanctuaries.`,
...
The coastal shelf off Mogadishu supports rich pelagic fisheries including king mackerel, sailfish, and skipjack tuna. Today, Mogadishu’s shoreline is undergoing a vibrant revival, with coastal cafes, watersports enthusiasts, and ocean research institutes taking root.`,
    ...
    highlights: [
      ...
      'Headquarters of Blue Heaven Marine Research and Education',
    ],
    marineSpecies: [
      {
        id: 'sailfish',
...
The beach is protected by a series of nearshore sandbanks and submerged coral outcrops that create safe swimming conditions inside the surf zone. Blue Heaven conducts regular youth ocean literacy campaigns and community beach stewardship events right here.`,
