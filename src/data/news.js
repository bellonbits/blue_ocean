...
const rawArticles = [
  {
    ...
    author: 'Blue Heaven Elasmobranch Research Unit',
    date: '2026-08-22',
    ...
    excerpt: 'Blue Heaven researchers documented a 9-metre whale shark near Bosaso — the first recorded sighting in this stretch of coast in over a decade, highlighting the rich marine biodiversity of northern Somalia.',
    content: [
      paragraph('A juvenile whale shark, measured at roughly nine metres, was photographed and logged by Blue Heaven\'s Elasmobranch Research Unit during a routine survey off Bosaso this week — the first confirmed sighting this far north along the Gulf of Aden coast in over a decade.'),
      ...
      pullquote('A sighting this far north tells us the feeding range may be wider than our tagging data alone has shown.', 'Blue Heaven Elasmobranch Research Unit'),
    ...
    translations: {
      so: {
        ...
        content: [
          ...
          pullquote('Aragti ku beegan meel u fog dhinaca waqooyi waxay noo sheegeysaa in aagga daaqa ay ku ballaaran tahay in ka badan waxa xogtayada calaamadaynta oo keliya ay muujisay.', 'Blue Heaven Elasmobranch Research Unit'),
  ...
  },
  {
    ...
    category: 'research',
    author: 'Blue Heaven Cetacean & Marine Mammal Research Unit',
    date: '2026-08-18',
    ...
    content: [
      paragraph('Blue Heaven\'s Cetacean & Marine Mammal Research Unit has launched a multi-week boat-based survey along the Gulf of Aden corridor, deploying hydrophones and conducting visual transects between Bosaso and Qandala.'),
      ...
      pullquote('Every acoustic detection and every photo-ID match makes the eventual corridor proposal more defensible.', 'Blue Heaven Cetacean & Marine Mammal Research Unit'),
    ...
    translations: {
      so: {
        ...
        content: [
          ...
          pullquote('Ogaansho dhawaq kasta iyo isku-ekaansho sawir aqoonsi kastaaba waxay ka dhigaan soo jeedinta waddada ugu dambaysa mid loo adkeysan karo si sax ah.', 'Blue Heaven Cetacean & Marine Mammal Research Unit'),
  ...
  },
  {
    ...
    author: 'Blue Heaven Pollution & Water Quality Team',
    date: '2026-08-10',
    ...
    excerpt: 'Volunteers from coastal communities in Kismayo and Mogadishu joined Blue Heaven\'s quarterly cleanup, removing a significant volume of plastic waste and reinforcing the debris-density map behind the effort.',
    content: [
      paragraph('The latest round of Blue Heaven\'s Southern Coast Community Beach Cleanup Network drew volunteers from Kismayo and Liido Beach, Mogadishu, for a coordinated single-day cleanup across both debris-density hotspots identified by the ongoing mapping program.'),
      ...
      pullquote('You can\'t clean what you haven\'t mapped — and you can\'t keep it clean without showing up again next quarter.', 'Blue Heaven Pollution & Water Quality Team'),
    ],
    ...
    translations: {
      so: {
        ...
        excerpt: 'Mutadawiciin ka socda bulshooyinka xeebaha Kismaayo iyo Muqdisho ayaa ka qayb qaatay nadaafadda saddex-biloodlaha ah ee Blue Heaven, iyagoo saaray qadar aad u weyn oo qashin plastik ah oo sidoo kale xoojiyay khariidada cufnaanta qashinka ee dadaalkan ka dambeysa.',
        readTime: '3 Daqiiqo Akhris',
        content: [
          paragraph('Wareegga ugu dambeeyay ee Shabakada Nadaafadda Xeebaha Bulshada Koonfurta ee Blue Heaven ayaa soo jiitay mutadawiciin ka socda Kismaayo iyo Xeebta Liido, Muqdisho, si loo sameeyo nadaafad hal-maalin ah oo isku duwan oo daboolaysa labada goob ee qashinku ugu badan yahay ee uu aqoonsaday barnaamijka khariidaynta ee socota.'),
          ...
          pullquote('Ma nadiifin kartid wax aadan khariidayn — mana sii nadiifin kartid iyadoon aad dib usoo noqon rubuca soo socda.', 'Blue Heaven Pollution & Water Quality Team'),
        ],
        gallery: [
  ...
  },
  {
    ...
    category: 'conservation',
    author: 'Blue Heaven Coral Reef & Coastal Ecosystems Unit',
    date: '2026-08-05',
    ...
    content: [
      paragraph('It has been a known gap for more than two decades: Somalia has no Marine Protected Areas, and no legislation governing how one would be established. Blue Heaven\'s Coral Reef & Coastal Ecosystems Unit has now drafted a zoning proposal aimed at closing that gap.'),
      ...
      pullquote('The reefs that can survive what\'s coming are exactly the ones we should be protecting first.', 'Blue Heaven Coral Reef & Coastal Ecosystems Unit'),
    ...
    translations: {
      so: {
        ...
        readTime: '5 Daqiiqo Akhris',
        content: [
          paragraph('Waa faraq la yaqaan in ka badan labaatan sano: Soomaaliya ma laha Aagag Badeed oo la Ilaaliyo, mana laha sharci xukuma sida mid loo dhisi lahaa. Xarunta Jiirka Badda iyo Deegaannada Xeebaha ee Blue Heaven ayaa hadda qorsheysay soo jeedin qaybineed oo ujeeddadeedu tahay in la xiro faraqaas.'),
          ...
          pullquote('Jiirada awoodda u leh inay ka badbaadaan waxa soo socda ayaa ah kuwa ugu horreeya ee ay tahay inaan ilaalino.', 'Blue Heaven Coral Reef & Coastal Ecosystems Unit'),
  ...
  },
  {
    ...
    author: 'Blue Heaven Fisheries Science Team',
    date: '2026-07-28',
    ...
    excerpt: 'The Bosaso Fishing Cooperative has become the pilot fleet for Blue Heaven\'s Fair Trade Handline Certification, giving export buyers a way to recognize sustainably caught Somali tuna for the first time.',
    content: [
      paragraph('The Bosaso Fishing Cooperative has completed the pilot phase of Blue Heaven\'s Fair Trade Handline Certification program, becoming the first Somali fleet able to formally label its yellowfin tuna catch as certified sustainable.'),
      ...
      pullquote('Handline was already one of the most selective methods there is. Now the market can actually tell.', 'Blue Heaven Fisheries Science Team'),
    ],
    ...
    translations: {
      so: {
        ...
        excerpt: 'Iskaashatada Kalluumeysiga Boosaaso waxay noqotay kooxda tijaabada ah ee Shahaadada Ganacsiga Caadilka ah ee Kalluumeysiga Xadhigga ee Blue Heaven, taasoo siisa iibsadayaasha dibadda hab ay markii ugu horreysay ku aqoonsan karaan tuna-ga Soomaaliyeed ee si waara loo qabtay.',
        readTime: '4 Daqiiqo Akhris',
        content: [
          paragraph('Iskaashatada Kalluumeysiga Boosaaso ayaa dhammaystay marxaladdii tijaabada ee barnaamijka Shahaadada Ganacsiga Caadilka ah ee Kalluumeysiga Xadhigga ee Blue Heaven, iyagoo noqday kooxdii ugu horreysay ee Soomaaliyeed ee si rasmi ah ugu calaamadin karta kaydkooda tuna-ga yellowfin-ka inuu yahay mid la shahaaday oo waara.'),
          ...
          pullquote('Kalluumeysiga xadhigga horeba wuxuu ahaa mid ka mid ah habab ugu doorbidan. Hadda suuqu runtii wax ka garan karaa.', 'Blue Heaven Fisheries Science Team'),
        ],
        gallery: [
  ...
  },
  {
    ...
    category: 'tourism',
    author: 'Blue Heaven Editorial Team',
    date: '2026-07-20',
    ...
    content: [
      ...
      pullquote('This is one of the last stretches of Somali reef most divers have never heard of.', 'Blue Heaven Editorial Team'),
      paragraph('The archipelago also sits inside the zone flagged as Somalia\'s highest coral-conservation priority, which means every visit here doubles as a first-hand look at exactly the reefs Blue Heaven\'s MPA zoning proposal is built around.'),
    ],
    ...
    translations: {
      so: {
        ...
        content: [
          ...
          pullquote('Tani waa mid ka mid ah dhabaha jiirka Soomaaliyeed ee ugu dambeeya ee quusidiinta badankood ayan waligood maqal.', 'Blue Heaven Editorial Team'),
          paragraph('Jasiiradahani sidoo kale waxay ku yaalliin aagga lagu calaamadiyay mudnaanta ugu sarreysa ee ilaalinta jiirka ee Soomaaliya, taasoo micnaheedu yahay booqasho kastaa waxay noqonaysaa fursad si toos ah loogu arko jiirada uu ku dhisan yahay soo jeedinta qaybinta MPA ee Blue Heaven.'),
        ],
        gallery: [
  ...
  },
  {
    ...
    category: 'marine-life',
    author: 'Blue Heaven Sea Turtle Research Unit',
    date: '2026-07-12',
    ...
    content: [
      ...
      pullquote('A research team can\'t be on a beach every night for an entire season. A trained local network can.', 'Blue Heaven Sea Turtle Research Unit'),
    ...
    translations: {
      so: {
        ...
        content: [
          ...
          pullquote('Kooxda cilmi-baaristu ma joogi karto xeeb habeen kasta xilli oo dhan. Shabakad maxalli ah oo tababaran waa awoodaa.', 'Blue Heaven Sea Turtle Research Unit'),
  ...
  },
  {
    ...
    content: [
      ...
      pullquote('The same current that reverses direction twice a year is the reason this coast can feed as much life as it does.', 'Blue Heaven Editorial Team'),
      paragraph('This seasonal engine is a large part of why field seasons for Blue Heaven\'s own research — from whale shark tagging to tuna sampling — are built around the monsoon calendar rather than the Gregorian one.'),
    ],
    ...
    translations: {
      so: {
        ...
        content: [
          ...
          pullquote('Isla qulqulka labo jeer sanadkiiba rogaya jihadiisa ayaa ah sababta xeebtani ay awood u leedahay inay quudiso nolol tiro badan sida ay hadda u leedahay.', 'Blue Heaven Editorial Team'),
          paragraph('Mishiinkan xilliyeed waa qayb weyn oo ka mid ah sababta xilliyada duurka ee cilmi-baarista Blue Heaven laftiisa — laga bilaabo calaamadaynta sharka weyn ilaa tijaabinta tuna-ga — loogu dhisay jadwalka monsoon-ka halkii ay ka noqon lahaayeen kan Gregorian-ka.'),
        ],
        gallery: [
  ...
  },
  {
    ...
    category: 'research',
    author: 'Blue Heaven Marine Biodiversity Unit',
    date: '2026-06-24',
    ...
    content: [
      paragraph('Blue Heaven\'s Marine Biodiversity Unit has completed a systematic drone-based aerial survey of the Bajuni Archipelago\'s seagrass channels, confirming a small, resident dugong population using the channels year-round — one of the last such strongholds documented anywhere in East Africa.'),
      ...
      pullquote('Finding them was the hard part. Keeping them here is the part that matters now.', 'Blue Heaven Marine Biodiversity Unit'),
    ...
    translations: {
      so: {
        ...
        readTime: '4 Daqiiqo Akhris',
        content: [
          paragraph('Xarunta Kala-duwanaanta Noolaha Badda ee Blue Heaven ayaa dhammaystay sahan hawada ah oo si nidaam leh loo sameeyay oo lagu sahamiyay jidadka cawska badda ee Jasiiradaha Baajuun, iyadoo xaqiijisay kooxo yar oo dugong ah oo deggan oo sannad-dhan isticmaala jidadkaas — mid ka mid ah qalcadaha ugu dambeeya ee noocaas oo laga diiwaan geliyay meel kasta oo Bariga Afrika ah.'),
          ...
          pullquote('Helitaankoodu wuxuu ahaa qaybta ugu adkeyd. Halkan ku hayntoodu waa qaybta hadda muhiimka ah.', 'Blue Heaven Marine Biodiversity Unit'),
  ...
  },
  {
    ...
    content: [
      ...
      paragraph('Unlike a regulation imposed from outside, the accord was co-designed by the same crews now following it — a distinction Blue Heaven\'s Fisheries Science Team credits directly for its durability two seasons in.'),
      pullquote('It held because they wrote it, not because someone made them follow it.', 'Blue Heaven Fisheries Science Team'),
    ],
    ...
    translations: {
      so: {
        ...
        content: [
          ...
          paragraph('Si ka duwan xeer dibadda laga soo rogay, heshiiskan waxaa wada naqshadeeyay isla ashkarta hadda raacaysa — farqigan ayaa Kooxda Sayniska Kalluumeysiga ee Blue Heaven si toos ah ugu tiriyaan sababta uu u sii jiray labadan xilli.'),
          pullquote('Wuu sii jiray sababtoo ah iyagaa qoray, ee ma ahan sababtoo ah qof baa ku qasbay inay raacaan.', 'Blue Heaven Fisheries Science Team'),
        ],
        gallery: [
