...
// Blue Heaven Somalia — Sprint 3: Marine Life Field Guide
//
...
export const speciesList = [
  // 1. Bottlenose Dolphin (Dolphins & Whales)
  {
    ...
    gallery: [
      { url: '/marine_dolphins.jpg', caption: 'Pod of bottlenose dolphins riding the bow wake in the Gulf of Aden near Bosaso.', photographer: 'Blue Heaven Marine Survey' },
  ...
  // 2. Whale Shark (Sharks & Rays)
  {
    ...
    gallery: [
      { url: '/marine_sharks.jpg', caption: 'Juvenile whale shark feeding near the surface off Cap Guardafui.', photographer: 'Blue Heaven Survey Team' },
  ...
  // 3. Green Sea Turtle (Sea Turtles)
  {
    ...
    gallery: [
      { url: '/marine_turtles.jpg', caption: 'Adult green sea turtle grazing on seagrass in Bajuni shallows.', photographer: 'Blue Heaven Turtle Project' },
  ...
  // 4. Yellowfin Tuna (Fish)
  {
    ...
    gallery: [
      { url: '/exp_coral_snorkeling.jpg', caption: 'Yellowfin tuna hunting along the coral reef drop-off.', photographer: 'Blue Heaven Fisheries Team' },
  ...
  // 5. Staghorn & Table Coral (Coral Reefs)
  {
    ...
    gallery: [
      { url: '/marine_coral.jpg', caption: 'Pristine table and branching coral garden in Bajuni Archipelago.', photographer: 'Blue Heaven Coral Survey' },
  ...
  // 6. Humpback Whale (Dolphins & Whales)
  {
    ...
    gallery: [
      { url: '/exp_coastal_cliff.jpg', caption: 'Humpback whales breaching off the cliffs of Bari during winter migration.', photographer: 'Blue Heaven Cetacean Unit' },
  ...
  // 7. Oceanic Manta Ray (Sharks & Rays)
  {
    ...
    gallery: [
      { url: '/exp_scuba_diving.jpg', caption: 'Giant oceanic manta ray hovering at a reef cleaning station in Bajuni.', photographer: 'Blue Heaven Expedition' },
  ...
  // 8. Hawksbill Sea Turtle (Sea Turtles)
  {
    ...
    heroImage: '/marine_turtles.jpg',
    gallery: [
      { url: '/marine_turtles.jpg', caption: 'Hawksbill turtle foraging for sponges along a coral pinnacle.', photographer: 'Blue Heaven Coral Unit' },
  ...
  // 10. Ribbon Seagrass & Dugong Forage (Seagrass)
  {
    ...
    gallery: [
      { url: '/marine_seagrass.jpg', caption: 'Vast sub-tidal seagrass meadow in clear shallow waters of Bajuni.', photographer: 'Blue Heaven Carbon Project' },
  ...
  // 11. Giant Clam (Other Marine Life)
  {
    ...
    heroImage: '/marine_coral.jpg',
    gallery: [
      { url: '/marine_coral.jpg', caption: 'Fluted giant clam embedded in a pristine Acropora reef head.', photographer: 'Blue Heaven Invertebrate Survey' },
  ...
  // 12. Dugong (Dolphins & Whales / Marine Mammal)
  {
    ...
    heroImage: '/marine_seagrass.jpg',
    gallery: [
      { url: '/marine_seagrass.jpg', caption: 'Dugong feeding in shallow seagrass meadow in Lower Juba.', photographer: 'Blue Heaven Sirenia Project' },
