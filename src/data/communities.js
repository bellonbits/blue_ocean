...
export const communities = [
  {
    ...
    marineConnection: 'The cooperative\'s fleet fishes the same Gulf of Aden corridor Blue Heaven surveys for dolphin and whale movement, making it a direct partner in both fisheries and cetacean conservation work.',
    ...
    translations: {
      so: {
        ...
        marineConnection: 'Doonyaha iskaashatadu waxay ku kalluumaystaan isla marinka Khaliijka Cadmeed ee Blue Heaven ku sahamiso dhaqdhaqaaqa dhurwaaga badda iyo nibiriga, taasoo ka dhigaysa lammaane toos ah oo ku lug leh kalluumaysiga iyo ilaalinta xayawaanka badda.',
  ...
  },
  {
    ...
    marineConnection: 'The collective works the same Kismayo landings connected to Blue Heaven\'s seagrass and sirenian protection work in the surrounding Bajuni Archipelago waters.',
    ...
    translations: {
      so: {
        ...
        marineConnection: 'Ururku wuxuu ka shaqeeyaa isla marsooyinka Kismaayo ee la xiriira shaqada Blue Heaven ee ilaalinta cawsduurka badda iyo xayawaanka sirenian-ka ee biyaha ku hareeraysan Jasiiradaha Bajuun.',
  ...
  },
  {
    ...
    marineConnection: 'Liido Beach is both the Alliance\'s commercial center and one of the two sites in Blue Heaven\'s ongoing debris-density mapping and water-quality monitoring work.',
    ...
    translations: {
      so: {
        ...
        marineConnection: 'Xeebta Liido waa xarunta ganacsi ee Isbahaysiga isla markaana ah mid ka mid ah labada goobood ee Blue Heaven ku sahamiso qiyaasta qashinka badda iyo kormeerka tayada biyaha.',
...
const rawStories = [
  {
    ...
    author: 'Blue Heaven Coastal Communities Team',
    date: '2025',
    storyContent: [
      ...
      'That changed when the cooperative became the pilot fleet for Blue Heaven\'s Fair Trade Handline Certification program, built on a published stock assessment showing the local yellowfin tuna population sitting within sustainable limits — as long as fishing pressure stays where it is.',
      ...
      'The cooperative has also become an informal early-warning network for Blue Heaven\'s cetacean research — crews now report dolphin and whale sightings from their daily routes, feeding directly into the corridor mapping used for the Marine Mammal Migration Safe Corridors initiative.',
    ],
    marineConnection: 'Bosaso\'s handline fleet works the same Gulf of Aden waters where Blue Heaven tracks resident dolphin pods and migratory humpback whales.',
    ...
    translations: {
      so: {
        ...
        storyContent: [
          ...
          'Taasi way beddelantay markii iskaashatadu ay noqotay doonyaha tijaabada ee barnaamijka Shahaadada Ganacsiga Cadaaladda ah ee Xadhig-gacmeedka ee Blue Heaven, kaasoo ku dhisan qiimeyn kaydka la daabacay oo muujinaysa in dadka tuna huruudda ah ee maxalliga ah ay ku jiraan xadka waarta — haddii cadaadiska kalluumaysiga uu sii ahaado sida uu hadda yahay.',
    ...
    translations: {
      so: {
        ...
        storyContent: [
          ...
          'Markii Kooxda Sayniska Kalluumaysiga ee Blue Heaven ay bilaabeen sahaminta jarralayaasha Bari sanadkii 2022, waxaa cilmi-baarayaasha tilmaamay kalluumaystayaasha Cayl qaababka cufnaanta ee ugu horreeya ee la qiyaasi lahaa. Daraasaddii soo baxday waxay xaqiijisay wixii jiillo badan oo urursanayaasha lobster-ka ay shaki ku qabeen: ilaalinta dheddigga ugxanta sida ayaa ka muhiimsanayd kaqab kasta oo kale oo laga heli karo.',
  ...
  },
  {
    ...
    storyContent: [
      ...
      'Young residents of the Hafun Peninsula now walk the tombolo beaches on a rotating schedule through the nesting months, watching for disturbed nests, deterring predators and interference, and logging what they find for Blue Heaven\'s Sea Turtle Research Unit.',
    ...
    translations: {
      so: {
        ...
        storyContent: [
          ...
          'Dadka dhallinyarada ah ee ku dhaqan Cirifka Xaafuun ayaa hadda socda xeebaha tombolo-ga jadwal wareeg ah oo dhan bilaha ugxanta, iyagoo eegaya ugxan la khalkhaliyay, ka hortagaya ugaadhsatada iyo faragelinta, oo diiwaangelinaya waxay helaan Xarunta Cilmi-baarista Diinyada Badeedka ee Blue Heaven.',
  ...
  },
  {
    ...
    storyContent: [
      ...
      'When Blue Heaven\'s debris-mapping work confirmed Liido as one of the two highest-concentration sites on the southern coast, a group of beachfront operators organized into the Mogadishu Coastal Business Alliance to fund and staff a recurring cleanup calendar rather than wait for outside support.',
      'The Alliance now underwrites the equipment and local labor for quarterly cleanups, and hosts the public postings of Blue Heaven\'s ongoing water-quality guidance for the beach — giving swimmers and visitors a source of information that used to exist only in research files.',
    ...
    marineConnection: 'Liido Beach is one of two sites in Blue Heaven\'s ongoing marine debris and water-quality monitoring program.',
    ...
    translations: {
      so: {
        ...
        storyContent: [
          ...
          'Markii shaqada khariidaynta qashinka ee Blue Heaven ay xaqiijisay in Liido ay tahay mid ka mid ah labada goobood ee ugu badan qashinka xeebta koonfureed, koox ganacsato xeebta ku teedsan ayaa isugu urursaday Isbahaysiga Ganacsiga Xeebaha ee Muqdisho si ay u maalgeliyaan oo u shaqaaleeyaan jadwal nadaafad oo soo noqnoqda, halkii ay ka sugi lahaayeen taageero dibadeed.',
          'Isbahaysigu hadda wuxuu bixiyaa qalabka iyo shaqaalaha maxalliga ah ee nadaafadaha saddex bilood mar ah, wuxuuna martigeliyaa dhagayska tayada biyaha ee Blue Heaven ee dadweynaha loo dhigo xeebta — isagoo dabbaasha iyo booqdayaasha siinaya isha macluumaad ee hore u koobnayd faylalka cilmi-baarista.',
        ...
        marineConnection: 'Xeebta Liido waa mid ka mid ah labada goobood ee barnaamijka Blue Heaven ee kormeerka qashinka badda iyo tayada biyaha uu socdo.',
      },
    },
  },
  {
    ...
    storyContent: [
      ...
      'The Collective\'s working waters sit at the edge of the Bajuni Archipelago\'s seagrass channels — the same waters where Blue Heaven surveys one of East Africa\'s last resident dugong populations — and members have become informal partners in keeping an eye on the health of the channels they depend on daily.',
    ],
    ...
    translations: {
      so: {
        ...
        storyContent: [
          ...
          'Biyaha ay Ururku ka shaqeeyo waxay ku yaalaan cirifka marinnada cawsduurka badda ee Jasiiradaha Bajuun — isla biyahaas oo Blue Heaven ku sahamiso mid ka mid ah dadyowga dugong-ga ugu dambeeya ee Bariga Afrika ku nool — xubnuhuna waxay noqdeen lammaane aan rasmi ahayn oo ilaaliya caafimaadka marinnada ay maalin walba ku tiirsan yihiin.',
        ],
